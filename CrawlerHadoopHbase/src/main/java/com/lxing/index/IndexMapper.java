...
public class IndexMapper extends
                         TableMapper<ImmutableBytesWritable, LuceneDocumentWritable> {
    ...
    public void map(ImmutableBytesWritable key,
        ...
        logger.info(rowKey);
        String author = Bytes.toString(values.getValue("info".getBytes(),
                                                       "author".getBytes()));
        String title = Bytes.toString(values.getValue("info".getBytes(),
                                                      "title".getBytes()));
        String content = Bytes.toString(values.getValue("info".getBytes(),
                                                        "content".getBytes()));
        // rowkey只存储
